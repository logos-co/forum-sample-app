...
Item {
    ...
    readonly property var backend: logos.module("forum_ui")
    ...
    Connections {
        ...
        function onViewModuleReadyChanged(moduleName, isReady) {
            if (moduleName === "forum_ui")
                root.ready = isReady && root.backend !== null
        }
    }
    Component.onCompleted: {
        root.ready = root.backend !== null && logos.isViewModuleReady("forum_ui")
    }
    ...
    function callForum(method, args) {
        if (!root.ready) {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                text: "Add"
                enabled: root.ready
                onClicked: root.callForum("add", [parseInt(inputA.text) || 0, parseInt(inputB.text) || 0])
            }
        }
        ...
        RowLayout {
            ...
            Button {
                ...
                enabled: root.ready
                onClicked: root.callForum("getVersion", [parseInt(inputN.text) || 0])
            }
        }
